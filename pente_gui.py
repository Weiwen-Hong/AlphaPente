...
class PenteGUI:
    ...
    def setup_frame(self):
        ...
        """
        self._frame = simplegui.create_frame("Pente",
                                             GUI_WIDTH,
                                             GUI_HEIGHT)
    ...
    def newgame(self):
        ...
        Start new game.
        """
        self._board = provided.PenteBoard(self._size, self._reverse)
...
def run_gui(board_size, ai_player, ai_function, ntrials, reverse = False):
    ...
    """
    gui = PenteGUI(board_size, ai_player, ai_function, ntrials, reverse)
    gui.start()
